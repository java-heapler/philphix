...
typedef struct HashTable {
  ...
  unsigned int (*hashFunction)(void *); // function used to hash (given a value in createHashTable)
  int (*equalFunction)(void *, void *); // equals function (given a value in createHashTable)
  HashBucketEntry **buckets; // a pointer to array of pointers of type HashBucketEntry, whose size is defined in createHashTable
} HashTable;
